...
if( isset($_GET["orderby"])){
    $resultado = $conexion ->query("select * from productos order by ".$_GET["orderby"]." desc")or die($conexion->error);
...
<body>
   ...
   <div class="shop-category">
       <div class="shop-category-first">
           <h3>Se muestran 1–12 de 43 resultados
            </h3>
       </div>
       <div class="shop-category-second">
           <select>
            <option value="Clasificación por defecto">Clasificación por defecto</option>
            <option value="Ordenar por popularidad">Ordenar por popularidad</option>
            <option value="Ordenar por calificación promedio">Ordenar por calificación promedio</option>
            <option value="Ordenar por último">Ordenar por último</option>
